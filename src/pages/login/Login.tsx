    ...
    <div className="page login-page">
      <div className='login-wrapper'>
        ...
        <div className='user-card'>
          <Header5>
            Are you a clinician or nurse? Sign in below!
          </Header5>
          <Input variant="single-line" label="Enter your user ID" placeholder='z1234567' leftIcon={<ScanFace size={16} />}/>
          ...
          <Header6>
            Don't have an account just yet? Contact us at ___ to be set up.
          </Header6>
        </div>
      </div>
    </div>
